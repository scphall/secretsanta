...
Welcome to ``secretsanta`` contributor's guide.
...
If you experience bugs or general issues with ``secretsanta``, please have a look
...
You can help improve ``secretsanta`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``secretsanta`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``secretsanta``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n secretsanta python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/secretsanta.git
    cd secretsanta
...
#. Install |pre-commit|_::
   ...
   ``secretsanta`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/secretsanta
.. _issue tracker: https://github.com/<USERNAME>/secretsanta/issues
.. <-- end -->
